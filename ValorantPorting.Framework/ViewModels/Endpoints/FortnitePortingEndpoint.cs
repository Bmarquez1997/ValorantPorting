...
namespace ValorantPorting.Framework.ViewModels.Endpoints;

public class ValorantPortingEndpoint : EndpointBase
{
    public const string AES_URL = "https://halfheart.dev/valorant-porting/api/v2/aes.json";
    public const string MAPPINGS_URL = "https://halfheart.dev/valorant-porting/api/v2/mappings.json";
    private const string RELEASE_URL = "https://halfheart.dev/valorant-porting/api/v2/release.json";
    private const string CHANGELOG_URL = "https://halfheart.dev/valorant-porting/api/v2/changelog.json";
    private const string FEATURED_URL = "https://halfheart.dev/valorant-porting/api/v2/featured.json";

    public ValorantPortingEndpoint(RestClient client) : base(client)
    {
    }
