...
namespace ValorantPorting.Extensions;
...
public class ViewDimensionsAttribute(int width, int height) : Attribute
{
    public int Width = width;
    public int Height = height;
}

public static class ViewDimensionsExtensions
{
    public static bool HasDimensions(this Enum value)
    {
        var attribute = value
            .GetType()
            .GetField(value.ToString())?
            .GetCustomAttributes(typeof(ViewDimensionsAttribute), false)
            .SingleOrDefault() as ViewDimensionsAttribute;
        return attribute is not null;
    }

    public static int GetWidth(this Enum value)
    {
        var attribute = value
            .GetType()
            .GetField(value.ToString())?
    ...
    public static int GetHeight(this Enum value)
    {
        var attribute = value
            .GetType()
            .GetField(value.ToString())?
