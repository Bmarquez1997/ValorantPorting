...
public static class DependencyService
{
    ...
    public static void EnsureDependencies()
    {
        TaskService.Run(() =>
        {
            ...
            EnsureResourceBased("Plugins/Blender/ValorantPorting/enable_addon.py", BlenderScriptFile);
    ...
    {
        var assetStream = AssetLoader.Open(new Uri($"avares://ValorantPorting/{path}"));
