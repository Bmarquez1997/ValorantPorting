...
public class SoundExportData : ExportDataBase
{
    ...
    public SoundExportData(string name, UObject asset, List<UObject> styles, EAssetType type, EExportTargetType exportType) : base(name, asset, styles, type, EExportType.Sound, exportType)
    {
