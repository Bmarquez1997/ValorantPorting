...
public class AnimExportData : ExportDataBase
{
    ...
    public AnimExportData(string name, UObject asset, List<UObject> styles, EAssetType type, EExportTargetType exportType) : base(name, asset, styles, type, EExportType.Animation, exportType)
    {
        switch (type)
        {
