...
using ValorantPorting.Controls.Avalonia;
...
using ReactiveUI;
using Serilog;
using TexturePreviewWindow = ValorantPorting.Windows.TexturePreviewWindow;
...
public partial class FilesViewModel : ViewModelBase
{
    ...
    public async Task ScanContent()
    {
        await TaskService.RunAsync(async () =>
        {
            ...
            AppVM.RestartWithMessage("File Scanning Completed", "The file scanning process has finished. ValorantPorting will now restart.");
        });
    }
