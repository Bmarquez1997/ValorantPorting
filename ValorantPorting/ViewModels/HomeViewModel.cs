...
using ValorantPorting.Controls.Home;
...
{
    public readonly Bitmap DefaultHomeImage = new(Avalonia.Platform.AssetLoader.Open(new Uri("avares://ValorantPorting/Assets/HomeBackground.png")));
    [ObservableProperty] private string greetingText = "ValorantPorting";
