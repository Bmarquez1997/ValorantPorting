...
public partial class BlenderExportOptions : ExportOptionsBase
{
    ...
    [ObservableProperty, NotifyPropertyChangedFor(nameof(IsValorantRig))] private ERigType rigType = ERigType.Default;
    public bool IsValorantRig => RigType == ERigType.Valorant;
    ...
    [ObservableProperty] private bool useOctaneShaders = false;
