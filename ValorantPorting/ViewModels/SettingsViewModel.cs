...
public partial class SettingsViewModel : ViewModelBase
{
    ...
    [ObservableProperty] private VPVersion lastKnownUpdateVersion = Globals.Version;
    ...
    public async Task ResetSettings()
    {
        ...
        AppVM.RestartWithMessage("A restart is required.", "To reset all settings, ValorantPorting must be restarted.");
    }
